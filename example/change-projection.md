...
D3plus is able to use all of the projections made available by the [d3-geo](https://github.com/d3/d3-geo#projections) package. Assuming we have the same data and configuration as the [Simple Choropleth Example](https://d3plus.org/examples/d3plus-geomap/getting-started/):
